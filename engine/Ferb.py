...
class Ferb:
    def __init__(self, x, y):
        ...
        frame_count = 9   # Ferb has 9 frames per animation
        rows = 9          # Ferb has 3 animation sets (down, up, right)

        # If the sheet is wider than tall → horizontal layout
        if sheet_w > sheet_h:
        ...
        # If the sheet is taller than wide → vertical layout (SIDEWAYS)
        else:
